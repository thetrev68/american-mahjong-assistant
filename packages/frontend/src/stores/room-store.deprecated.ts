/**
 * @deprecated This store is being decomposed into smaller, domain-focused stores.
 * 
 * New stores:
 ...
 * 
 * Components should migrate to use the new stores instead of this monolithic one.
