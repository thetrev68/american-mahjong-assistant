import type { Player, Room, RoomConfig, PlayerPosition, ExposedSet, CharlestonState, CharlestonPhase, GameSettings, PlayerAction, ActionType } from './room-types';
import type { GameState, PlayerGameState, PrivatePlayerState, HandAnalysis } from './game-state-types';
...
export interface SocketEventMap {
    ...
    'phase-transition-response': {
        success: boolean;
        allReady?: boolean;
        readinessSummary?: Record<string, string[]>;
        error?: string;
    };
    'phase-changed': {
        fromPhase: string;
    ...
    'charleston-player-ready-confirmed': {
        success: boolean;
        playerId: string;
        phase: string;
    };
    'charleston-player-ready-update': {
        playerId: string;
        isReady: boolean;
        phase: string;
    };
    ...
    'provide-patterns-response': {
        patterns: NMJL2025Pattern[];
        responseId: string;
    };
    'selected-patterns-provided': {
        playerId: string;
        patterns: NMJL2025Pattern[];
        responseId: string;
    };
...
//# sourceMappingURL=socket-event-types.d.ts.map